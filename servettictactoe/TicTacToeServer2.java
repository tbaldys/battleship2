...
import servettictactoe.Game.Player;
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            while (true) {
                ...
                Game2.Player playerX = game.new Player(listener.accept(), 'X');
                Game2.Player playerO = game.new Player(listener.accept(), 'O');
